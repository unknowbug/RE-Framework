...
whenToUse: 二进制逆向需高精度还原函数/方法时（汇编→C++ 六步流程；禁止直接信任单一反编译输出如 IDA F5）
---
...
**步骤6 — anchor 载体**: 按 [Anchorlaw v0.17](https://github.com/unknowbug/anchorlaw) 协议产出 `@anchor.test` / `@anchor.idk`：

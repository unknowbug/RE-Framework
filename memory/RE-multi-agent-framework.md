...
description: 通用工程方法论框架（RE-Framework v2）——逆向/编程通用：模块化结构（core 必装 + re-binary/re-code/swe 可选）、置信度状态机、产物落盘、验证协议引用 Anchorlaw v0.6
metadata:
  type: project
---
...
**验证协议:** [Anchorlaw Protocol v0.6](https://github.com/unknowbug/anchorlaw)（协议引用，不复制）
